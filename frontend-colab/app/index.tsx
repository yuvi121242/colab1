...
export default function ColabApp() {
  ...
  const openBatterySettings = () => {
    ...
    Alert.alert(
      'Keep App Running',
      'To prevent Android from stopping Colab:\n\n1. Tap "Open Settings"\n2. Go to "Battery"\n3. Select "Unrestricted"',
      [
  ...
  useEffect(() => {
    ...
    return () => {
      if (Platform.OS !== 'web' && deactivateKeepAwake) deactivateKeepAwake('colab-session');
    };
  }, [keepAwakeEnabled]);
  ...
  const toggleKeepAwake = () => {
    ...
    if (keepAwakeEnabled && deactivateKeepAwake) deactivateKeepAwake('colab-session');
    else if (activateKeepAwakeAsync) activateKeepAwakeAsync('colab-session');
    ...
    return (
      <View style={[styles.container, { paddingTop: topPadding }]}>
        ...
        <ScrollView contentContainerStyle={styles.webFallback}>
          <Ionicons name="code-working" size={80} color={APP_COLOR} />
...
const styles = StyleSheet.create({
  ...
  progressBar: { height: '100%', backgroundColor: '#F9AB00' },
