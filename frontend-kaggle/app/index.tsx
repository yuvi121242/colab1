...
const styles = StyleSheet.create({
  ...
  showNavButton: { position: 'absolute', right: 20, width: 44, height: 44, borderRadius: 22, backgroundColor: '#20BEFF', justifyContent: 'center', alignItems: 'center', elevation: 5 },
